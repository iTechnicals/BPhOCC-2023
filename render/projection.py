...
class Projection:
    ...
    def update_matrix(self):
        ...
        self.render.camera.v_fov = self.render.camera.h_fov * self.render.height / self.render.width
        self.render.camera.cos_fov = math.cos(math.sqrt(2)*max(self.render.camera.h_fov/2, self.render.camera.v_fov/2))
        self.render.camera.d_cos_fov = math.cos(math.sqrt(2)*max(self.render.camera.h_fov, self.render.camera.v_fov))
